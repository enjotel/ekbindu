...
pariomalo
\app{\lem[wit={P,L,B,N1,N2,D1}]{manasā vacasā}
  \rdg[wit={U1}]{vacasā manasā}
  \rdg[wit={U2}]{manasā vācā}
  \rdg[wit={E}]{manaso vacaso}
}
\note[type=philcomm, labelb=s22.z4, lem={°manasā vacasā}]{All manuscripts at hand share this usage of the instrumentals. Only the printed edition conjectures the forms into the exspected genitiv.}
...
%tat karṇikāmadhye saptadaśī     ekā niraṃjanarūpā kalā vartate  \U1
