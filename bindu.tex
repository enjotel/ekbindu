...
\SetHooks{
  ...
  %appheight=0.75\textheight,
  %fitalgorithm=squeeze, %fontsize|hybrid|areasize|squeeze
}
...
\section{The List of the 15 Yogas}
\begin{itemize}
...
%--------------------------          
      \app{\lem[wit={ceteri}]{śrī gaṇeśāya namaḥ}
        ...
        \rdg[wit={U1}]{śrī gaṇeśāya namaḥ || oṃ śrī niraṃjanāya}}/\hskip-4pt/
      \app{\lem[wit={N1,N2,D1}]{atha rājayogaprakāro likhyate}
        ...
        \rdg[wit={U2}]{atha rājayoga likhyate}}/\hskip-4pt/
        \end{prose}
        \end{edition}
        \begin{translation}
          \ekddiv{type=trans}
...
eva/ anekapārthivavinoda
    ...
    \ekddiv{type=trans}
      \bigskip
      \begin{tlate} This is the result of \textit{rājayoga}\footnote{This statement seems unconnected to the definition of rājayoga that follows.}: \textit{Rājayoga} is that by which longterm durability of the body arises even amongst manifold royal pleasures even amongst the manifold royal entertainments and spectacle. This truly is \textit{rājayoga}. \\
        \\
        Of this [\textit{rājayoga}] these are the varieties:
\\
      \end{tlate}
...
%-------------------------
       \begin{prose}
        \noindent kriyāyogaḥ 1/\hskip-4pt/ \\
         jñānayogaḥ 2/\hskip-4pt/ \\
        \app{\lem[wit={ceteri}]{cāryayogaḥ}
          \rdg[wit={U1}]{tvaryāyogaḥ}} 3/\hskip-4pt/ \\
        haṭhayogaḥ 4/\hskip-4pt/ \\
        karmayogaḥ 5/\hskip-4pt/ \\
        \app{\lem[wit={ceteri}]{layayogaḥ}
          \rdg[wit={U2}]{nayayogaḥ}} 6/\hskip-4pt/ \\
        dhyānayogaḥ 7/\hskip-4pt/ \\
        mantrayogaḥ 8/\hskip-4pt/ \\
        \app{\lem[wit={ceteri}]{lakṣyayogaḥ}
          \rdg[wit={U1}]{lakṣayogaḥ}} 9/\hskip-4pt/ \\
        vāsanāyogaḥ 10/\hskip-4pt/ \\
        śivayogaḥ 11/\hskip-4pt/ \\ 
        brahmayogaḥ 12/\hskip-4pt/ \\
        advaitayogaḥ 13/\hskip-4pt/ \\
        \app{\lem[wit={P,U2}]{siddhayogaḥ}
          \rdg[wit={N1,N2,D1,U1}]{rājayogaḥ}} 14/\hskip-4pt/ \\
        \app{\lem[wit={P,U2}]{rājayogaḥ}
          \rdg[wit={ceteri}]{siddhayogaḥ}} 15/\hskip-4pt/ \\ \\
        \linelabel{s1.z6e}
        \note[type=philcomm, labelb=s4.z5a, lem={rājayoga}]{The initial codification of 15 \textit{yoga}s appears in N1,N2,P,D1,U1 and U2. It is ommitted in E and L. B can't be determined due to missing folios. P is the only witness which numbers the \textit{yoga}s with \textit{devanāgarī}-digits. I decided to include the numberation to improve the readability of the list.}
        \app{\lem[wit={P,N1,D1,U1}]{ete pañcadaśayogāḥ}
          \rdg[wit={U2}]{evaṃ paṃcadaśāyogā bhavaṃti}}/\hskip-4pt/ \\
      \end{prose}
    \end{edition}
    \begin{translation}
   \ekddiv{type=trans}
   \begin{tlate}
     \noindent 1. Yoga of [mental] action (\textit{kriyāyoga}), \\
     2. Yoga of knowledge (\textit{jñānayoga}), \\
     3. Yoga of wandering (\textit{caryāyoga}),\footnote{The first three Yogas allude to the four \textit{pāda}s of the Śaiva \textit{āgama}s; namely \textit{kriyā[pāda], caryā[pāda], yoga[padā]} and \textit{jñāna[pāda]}.\parencite[77]{nishvasa2015}.} \\
     4. Yoga of force (\textit{haṭhayoga}), \\
     5. Yoga of deeds (\textit{karmayoga}), \\
     6. Yoga of absorption (\textit{layayoga}), \\
     7. Yoga of meditation (\textit{dhyānayoga}), \\
     8. Yoga of mantras (\textit{mantrayoga}), \\
     9. Yoga of fixation objects (\textit{lakṣyayoga}), \\
     10. Yoga of mental residues (\textit{vāsanāyoga}), \\
     11. Yoga of Śiva (\textit{śivayoga}), \\
     12. Yoga of Brahman (\textit{brahmayoga}), \\
     13. Yoga of non-duality (\textit{advaitayoga}), \\
     14. Yoga of completion (\textit{siddhayoga}), \\
     15. Yoga of kings (\textit{rājayoga}). \\
    \\
     These are the fifteen \textit{yoga}s.\footnote{At the current stage of research it is not clear if this list is a later addition by another scribe or, if indeed it originally stems from Rāmacandra. The list suggests a text following the order of yogas according to this list. However, the order of the yogas given in the list is not followed closely in the text.}\bigskip \end{tlate}
    \end{translation}
  \end{alignment}
  \clearpage
\begin{alignment}[
...
%-------------------------- 
\tl{\app{\lem[wit={ceteri}, alt={kriyāmuktir}]{kriyāmukti\skp{r-}}
...
\tl{\app{\lem[wit={ceteri}]{tattataḥ}
  ...
  \app{\lem[wit={ceteri}]{kuñcanaṃ}
    ...
    \rdg[wit={U1}]{ato va}}/\hskip-4pt/1\hskip-2pt/\hskip-4pt/}
\end{tlg}
\end{edition}
\begin{translation}
\ekddiv{type=trans}
...
%--------------------------
  ...
  kriyāyogī nigadyate/\hskip-4pt/2\hskip-2pt/\hskip-4pt/}
\end{tlg}
    \end{edition}
    \begin{translation}
   \ekddiv{type=trans}
...
%-----------------------
       \tl{kāma\app{\lem[wit={U1,U2}, alt={°krodhau}]{krodhau}
         ...
         \app{\lem[wit={ceteri}]{'śuciḥ}
           \rdg[wit={E,N2,U2}]{śuciḥ}}/\hskip-4pt/3\hskip-2pt/\hskip-4pt/}    %%%AVAGRAHA
\end{tlg}
    \end{edition}
    \begin{translation}
   \ekddiv{type=trans}
...
%-----------------------
        \tl{\app{\lem[wit={ceteri}]{rāgadveṣau}
...
%  -----------------------        
        \tl{yasyai tāni \app{\lem[wit={ceteri}]{na}\rdg[wit={E}]{ca}} vidyante kriyāyogī sa ucyate/\hskip-4pt/4\hskip-2pt/\hskip-4pt/}\\
\bigskip
\end{tlg}
    \end{edition}
    \begin{translation}
...
sa eva \app{\lem[wit={ceteri}]{bahukriyāyogī}
  \rdg[wit={D1,U1,U2}]{°kiyā°}}
    ...
    \begin{translation}
   \ekddiv{type=trans}
   \begin{tlate}Fraud, illusion, property,violence, craving, envy, ego, anger, anxiety, shame, greed, error, impurity, attachment, aversion, idleness, heterodoxy, false view, affection of the senses, sexual desire:\\
     He who diminishes these from day to day in is mind, he alone is called a yogī of many actions (\textit{bahukriyāyogī}).\end{tlate}
    \end{translation}
  \end{alignment}
  % \clearpage
\begin{alignment}[
...
\app{\lem[resp=egoscr, type=emendation]{'syāṃ}
    ...
    \app{\lem[wit={E,P,N1,N2,D1,U1,U2}]{kathyante}
      \rdg[wit={L}]{kathyate}}/\hskip-4pt/
  \end{prose}
  \end{edition}
   \begin{translation}
    \ekddiv{type=trans}
      \begin{tlate}She \extra{emerges as the central channel, assuming the form of benevolence (\textit{śiva}),} is the bestower of enjoyment and liberation. While abiding in (\textit{satyāṃ}) her (\textit{asyāṃ}) knowledge arises [to the point of which] the person becomes all-knowing. The means for the genesis of knowledge in the central channel will now be described.\end{tlate}
   \end{translation}
 %  \end{alignment}
%\begin{alignment}[
%    texts=edition[class="edition"];
...
%-----------------------      
  ...
  \begin{translation}
    ...
    \centerline{\textrm{\small{[Description of the first Cakra]}}}
    \bigskip
    \begin{tlate}At the beginning\footnote{Supposedly at the beginning of the central channel.} exists the root-cakra having four petals.\end{tlate}
  \end{translation}
    \begin{edition}
      \ekddiv{type=ed}
      \begin{prose}     
        ...
        \extra{
          \app{\lem[wit={P,L,U2}]{prathamaṃ ādhāracakraṃ}
            ...
            \app{\lem[type=emendation, resp=egoscr]{siddhibuddhiśaktiṃ muṣako vāhanaṃ} %Emendation!!!
                 ...
                 \rdg[wit={U2}]{°śaktiḥ muṣako vāhanaṃ}}/\hskip-4pt/
            \app{\lem[type=emendation, resp=egoscr]{kūrma} %%sandhi aḥ vor ṛ wird zu a + ṛ 
                 \rdg[wit={U2}]{\korr kurma}}ṛṣiḥ/\hskip-4pt/
            \app{\lem[type=emendation, resp=egoscr]{ākuñcanaṃ mudrā}
                 \rdg[wit={P,L,U2}]{ākuñcana°}
                 \rdg[wit={E}]{\korr ākuṃca°}}mudrā/\hskip-4pt/
            \app{\lem[type=emendation, resp=egoscr]{apānaḥ vāyuḥ}
                 \rdg[wit={E,L}]{\korr apānavāyuḥ}
                 \rdg[wit={P}]{°vāyuś}
                 \rdg[wit={U2}]{°vāyu}}/\hskip-4pt/
               \extra{
                 \app{\lem[type=emendation, resp=egoscr]{ūrmī}
                   \rdg[wit={U2}]{\korr urmī}} kalā/\hskip-4pt/
                 ojasvinī dhāraṇā/\hskip-4pt/}
                 caturdaleṣu rajaḥsattvatamomanāṃsi/\hskip-4pt/
                 vaṃ śaṃ ṣaṃ saṃ/\hskip-4pt/ madhyatrikoṇe
            \app{\lem[wit={P,L}]{triśikhā}
                 \rdg[wit={E}]{triśikhāt}
                 \rdg[wit={U2}]{trirekhā}}/\hskip-4pt/}
           \end{prose}
        \end{edition}
      \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}\extra{The first cakra of support (\textit{ādhāra}) is at the anus [and] is red-colored. Gaṇeśa is the deity. He is success, intelligence and power. A rat is the mount. The Ṛṣi is Kūrma. The seal is contraction. The vitalwind is \textit{apāna}. The \textit{kalā} is the ``wave of consciousness'' (\textit{urmī}). The concentration is ``she who is powerful'' (\textit{ojasvinī}). In the four petals [of it resides] \textit{rajas}, \textit{sattva}, \textit{tamas} and the mind-faculties (\textit{manāṃsi}), [symbolized by the syllables or \textit{bīja}s] vaṃ śaṃ ṣaṃ and saṃ. A trident is situated in the middle of the triangle\footnote{This passage is odd since a triagle wasn't mentioned before.}.}\end{tlate}
         \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}             
            ...
            trikoṇākāraṃ kāmapiṭhaṃ vartate/\note[type=philcomm, labelb=s10.zx, lem={prathamaṃ ... triśikhā}]{The whole section from \textit{prathamaṃ} to \textit{triśikhā} is missing in N1,N2,D1 and U1, but present in all other witnesses.}
%-----------------------
%\om                                                      \B
...
\end{prose}
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}In the middle [of it] is a trident, and \textit{kāmapīṭha}\footnote{Discuss the term \textit{kāmapīṭha}.} in the shape of a triangle. In the middle of this seat (\textit{pīṭha}) exists a single form having the shape of a flame. Trough the practice of meditation on this form the whole literature, all \textit{śāstra}s, all poems, dramas etc., everything [related to] elocution, appears in the mind of the person without [prior] learning.\end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}
 % \rdg[wit={U2}]{sphurati // asya bahir mānaṃdā // yogānaṃdā virānaṃdā // uparamānaṃdā // ajapājapaśāt // 600 // ghaṭi 9 palāni 40 //}} / % Lesart oder zusätzliches Material? 
      \extra{asya
        \app{\lem[type=emendation, resp=egoscr, alt={bahir ānandā}]{bahir\skp{-}ānandā}
          \rdg[wit={U2}]{\korr bahir mānandā}}/\hskip-4pt/
        yogānandā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{vīrānandā}
          \rdg[wit={U2}]{\korr virā°}}/\hskip-4pt/
        uparam-ānandā/\hskip-4pt/}\note[type=philcomm, labelb=s9.z11, lem={asya bahir ānanda}]{This additional passage is found in U2 only and concluded in the manuscript with ``\textit{ajapājapaśat} || 600 || \textit{ghaṭi} 9 \textit{palāni} 40 ||''. Instruction for the duration of practice are found in all additions of U2 for each \textit{cakra}. It's not entirely clear if either the duration of meditation on the respective cakra, or the duration for the items in the list being visualised by the practitioner are meant here. However, whatever it exactly refers to, it seems to be done for the duration of 600 \textit{ajapājapa}, which is the voiceless uttering of the ``natural'' \textit{mantra} of the breath: \textit{so 'haṃ} - \textit{haṃ sa}. I suppose this means the practice is to be done for 600 in- and exhalations. The following part of the entry, namely ``\textit{ghaṭi} 9 \textit{palāni} 40'', probably refers to the exact time in which those 600 \textit{japājapa}s shall be performed. One \textit{ghaṭi} equals 1/60 of a day, which is 24 minutes. One \textit{pala} equals 1/60 of a \textit{ghaṭi} which is 24 seconds. This would equal 232 minutes or 3 hours and 52 minutes. This would result in a very slow frequence of breath of exactly 2,586206897 in- and exhalations per minute.}
    \end{prose}
   \end{edition}
\begin{translation}
  \ekddiv{type=trans}
    \begin{tlate}\extra{[Assigned to it] is external bliss\footnote{Discuss the four blisses.}, yogic bliss, heroic bliss [and] the bliss of coming to rest.}\footnote{It is noteworthy that only the first \textit{cakra} adds a detailled description of mounts, Ṛṣis, gods, seals and so forth among the current majority of witnesses at hand: E, P, L and U2. All other descriptions of the remaining eight \textit{cakra}s leave this out. The only exception is U2, a relatively late witness that adds those descriptions for the other \textit{cakra}s as well. Since it is probable that those descriptions are later additions to the text but rather interesting for the history of this text, I have added them to the edition's text and the translation as well. In order to indicate this I have highlighted them in color.}\end{tlate}
  \end{translation}
  \end{alignment}
  \begin{alignment}[
    texts=edition[class="edition"];
...
%-----------------------      
  ...
  \begin{translation}
    ...
    \centerline{\textrm{\small{[Description of the second Cakra]}}}
    \bigskip
    \begin{tlate}Now the second, the six-petalled \textit{Svādhiṣṭānacakra} known as the seat of \textit{Uḍḍīyāṇa}\footnote{Discuss the term \textit{uḍḍīyāna}.}.\end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}       
      \extra{\app{\lem[type=emendation, resp=egoscr]{liṅgaṃ}
          \rdg[wit={U2}]{\korr liṅga°}} sthānaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{pītaṃ}
          \rdg[wit={U2}]{\korr pīta°}} varṇaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{pītaṃ}
          \rdg[wit={U2}]{\korr pīta°}} prabhā/\hskip-4pt/
        rajo \app{\lem[type=emendation, resp=egoscr]{guṇaḥ}
          \rdg[wit={U2}]{\korr guṇa}}/\hskip-4pt/
        brahmā devatā/\hskip-4pt/
        vaikharī vāca/\hskip-4pt/
        sāvitrī śaktiḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{haṃso}
          \rdg[wit={U2}]{\korr haṃsa°}} vāhanaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{vahaṇo}
          \rdg[wit={U2}]{\korr vahaṇa}} ṛṣiḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr, alt={kāmāgnir}]{kāmāgni\skp{r-}}
          \rdg[wit={U2}]{\korr kāmāgni°}}\skm{r-}prabhā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{sthūlaḥ dehaḥ}
          \rdg[wit={U2}]{\korr sthūladehā}}/\hskip-4pt/
        jāgrad avasthā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{ṛgvedaḥ}
          \rdg[wit={U2}]{\korr ṛgveda}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{ācāryaḥ}
          \rdg[wit={U2}]{\korr ācārya°}} liṅgaṃ/\hskip-4pt/
        brahmasalokatā mokṣaḥ/\hskip-4pt/
        śuddhabhumikā tatvaṃ/\hskip-4pt/
        gaṃdho viṣayaḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{apānaḥ}
          \rdg[wit={U2}]{apāna°}}/\hskip-4pt/
        aṃtarmātṛkā/\hskip-4pt/
        vaṃ bhaṃ maṃ yaṃ raṃ laṃ/\hskip-4pt/
        bahir-mātrā/\hskip-4pt/
        kāmā/\hskip-4pt/
        kāmākhyā/\hskip-4pt/
        tejasī/\hskip-4pt/
        ceṣṭṛikā/\hskip-4pt/
        alasā/\hskip-4pt/
        mithunā/\hskip-4pt/}\note[type=philcomm, labelb=sX.zX, lem={liṅgasthānaṃ}]{This additional passage is found in U2 only and is indicated in the manuscript with ``\textit{ajapājapaḥ sahasra} || 6000 || \textit{gha.} 96 \textit{pa.} 40 ||''. \textit{Ajapājapa} is to be performed 6000 times for a duration of 96 \textit{ghaṭi}s and 40 \textit{pala}s, resulting in 2320 minutes or 38.67 hours. Again this would result in a frequence of breath of 2,586206897 in- and exhalations per minute.}
    \end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}\extra{The gender is the location. The color is yellow. The shine is yellow. \textit{Rajas} is the quality. The deity is Brahmā. The speech is \textit{vaikharī}\footnote{vaikharī f. in Kaśm. Śiv. °the 4. form of appearacne of \textit{parā}, the empirical speech sound, Utpala's Ṭīkā to Śivadṛṣṭi 2, 7. [B.]― Schmidt p. 337. Welches Buch???} (\textit{vaikharīvāca}). The power is Sāvitrī. The mount is the goose. The \textit{Rṣi} is Vahaṇa. The appearance (\textit{prabhā} is the fire of love (\textit{kāmāgni}). The body is gross, The state is that of being awake. [The Veda associated with it is] the Ṛgveda. The spiritual guide is the \textit{liṅga}. The liberation is residing in the world of Brahma. The Tattva is the pure earth (\textit{śuddhabhumikā}). The sphere is smell. The vitalwind is \textit{apāna}. The internal alphabet [is]: vaṃ bhaṃ maṃ yaṃ raṃ laṃ. The outer alphabet?: desire, the Tīrtha of \textit{Kāmākhyā}\footnote{The Kāmākhyā is situated in Kāmarūpa on the Nīlakūṭa mountain in present day Assam. It's strange that it appears here, since Kāmarūpa appears already as the Tīrtha associated with the first \textit{cakra}.}, beauty of both\footnote{Why dual here?}, \textit{ceṣṭṛikā} (what is that?), lazy [and] copulation.} \end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}      
...
%-----------------------
\extra{yuvatīnāṃ ativallabho bhavati}/\note[type=philcomm, labelb=s10.z5aa, lem={yuvatīnāṃ...bhavati}]{This additional sentence occurs in N2 only.}

\app{\lem[wit={ceteri}, alt={pratidinam}]{pratidinam\skm{-ā}}
  \rdg[wit={N1,U1}]{dinaṃ dinaṃ prati}
  \rdg[wit={N2}]{dinadinaṃ prati}
  \rdg[wit={D1}]{dinaṃ prati}}\skp{-ā}yur-vardhate/\hskip-4pt/
    \end{prose}
    \end{edition}
    \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
     In its middle exists extremely red glow. The adept becomes very handsome through meditation on it. \extra{He becomes one who is desired by young women.} The vital force increases from day to day. \end{tlate}
    \end{translation}
%
%
%
...
%-----------------------
%The third, a lotus with ten petals exists at the location of the navel.\extra{[It is] monkey-red (\textit{kapila}) in colour, [has] Viṣṇu as its deity, Lakṣmi [as its] power, Vāyu [as its] Rṣi, Samāna [as its] vitalwind, [its] mount is Garuḍa, [it belongs to] the deity of suble body, [it is assigned] to the state of sleep, the inaudible speech (\textit{madhyamāvāg}), the Yajurveda,  the southern fire, the [state which is] close to liberation (\textit{samīpatā})\footnote{The second type of liberation. Additional information will be added in the near future.}, the Viṣṇu of the penis of the teacher, [associated with it is] the Tattva of water, [being in] the sphere of space (\textit{rajoviṣaya}). It has ten parts [and] ten measures. [The] inner measures: \textit{ḍaṃ ṭaṃ ṇaṃ taṃ thaṃ daṃ dhaṃ naṃ paṃ phaṃ}. The external measures: peace, patience, insight, \textit{tanyā}?, a learned teacher, a lotus, ahaṃsagamanā?, the fixation object, absorption and immortality.}   
%-----------------------
...
\end{prose}
    ...
    \centerline{\textrm{\small{[Description of the third Cakra]}}}
    \bigskip
        \begin{tlate}The third, a lotus with ten petals exists at the location of the navel.\end{tlate}
      \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}    
      \extra{
        \app{\lem[type=emendation, resp=egoscr]{kapilaṃ}
          \rdg[wit={U2}]{\korr kapila°}} varṇaṃ/\hskip-4pt/
        viṣṇu devatā/\hskip-4pt/
        lakṣmī śaktiḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr, alt={vāyur}]{vāyu\skp{r-}}
          \rdg[wit={U2}]{\korr vayu°}}\skm{-r}ṛṣiḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{samāno}
          \rdg[wit={U2}]{\korr samāna°}} vāyuḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{garuḍo}
          \rdg[wit={U2}]{\korr garuḍa°}} vāhanaṃ/\hskip-4pt/
      \app{\lem[type=emendation, resp=egoscr]{sūkṣmaliṅgaṃ devatā}
        \rdg[wit={U2}]{\korr sūkṣmaliṅgadevatāha}}/\hskip-4pt/
      svapnāvasthā/\hskip-4pt/
      madhyamā vāk/\hskip-4pt/
      yajur vedaḥ/\hskip-4pt/
      dakṣināgniḥ/\hskip-4pt/
      \app{\lem[type=emendation, resp=egoscr]{samīpatā}
        \rdg[wit={U2}]{samipatā}} mokṣaḥ/\hskip-4pt/
      \app{\lem[type=emendation, resp=egoscr]{guruliṅgo}
        \rdg[wit={U2}]{\korr guruliṅga°}} viṣṇuḥ/\hskip-4pt/
      āpas tatvaṃ/\hskip-4pt/
      rajo viṣayaḥ/\hskip-4pt/
      daśadalāni/\hskip-4pt/
      daśamātrāḥ/\hskip-4pt/
      antarmātrā/\hskip-4pt/
      ḍaṃ ṭaṃ ṇaṃ taṃ thaṃ daṃ dhaṃ naṃ paṃ phaṃ/\hskip-4pt/
      bahirmātrāḥ/\hskip-4pt/
      śāṃtiḥ/\hskip-4pt/
      kṣamā/\hskip-4pt/
      medhā/\hskip-4pt/
      tanyā/\hskip-4pt/
      medhāvinī/\hskip-4pt/
      puṣkarā/\hskip-4pt/
      ahaṃsagamanā/\hskip-4pt/
      lakṣyā/\hskip-4pt/
      tanmayā/\hskip-4pt/
      amṛtā/\hskip-4pt/}\note[type=philcomm, labelb=s13.z4, lem={kapilavarṇaṃ}]{Again this additional passage is found in U2 only and as in the previous description of the second \textit{cakra} is indicated in the manuscript with ``\textit{ajapājapaḥ sahasra} || 6000 || \textit{gha.} 96 \textit{pa.} 40 ||''. \textit{Ajapājapa} is to be performed 6000 times for a duration of 96 \textit{ghaṭi}s and 40 \textit{pala}s, resulting in 2320 minutes or 38.67 hours. Again this would result in a frequence of breath of 2,586206897 in- and exhalations per minute.}
\end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{The colour is monkey-red (\textit{kapila}). Viṣṇu is the deity. Lakṣmī is the power. Vāyu is the Rṣi. Samāna is the vitalwind. The mount is Garuḍa. The deity is the suble body\footnote{Why another deity is given here?}. The state is sleep. The speech is the inaudible speech (\textit{madhyamāvāg})\footnote{<Śā, Ling>name of the speech which is inaudible and which is of the type of a thought without any definite presence of words making up the expression. Vkp I.143.<Abhyankar 1986: 300>}. The Veda is the Yajurveda. The [fire is the] southern fire. The liberation is (\textit{samīpatā})\footnote{What is this exactly?}. The \textit{guruliṅga} is Viṣṇu. The Tattva is water. The sphere is the air circle (\textit{rajo viṣaya}). There are ten petals [and] ten measures. [The] inner measure: \textit{ḍaṃ ṭaṃ ṇaṃ taṃ thaṃ daṃ dhaṃ naṃ paṃ phaṃ}. The external measure: peace, patience, insight, \textit{tanyā}?, a learned teacher, a lotus, ahaṃsagamanā?, the fixation object, absorption and immortality.}
    \end{tlate}
  \end{translation}
%
%
...
The fourth lotus having twelve-petals exists in the middle of the heart. 
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}
      \extra{anāhatacakraṃ hṛdayasthānaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{śvetaṃ}
          \rdg[wit={U2}]{\korr śveta°}} varṇaṃ/\hskip-4pt/
        tamo guṇaḥ/\hskip-4pt/
        rudro devatā/\hskip-4pt/
        umā śaktiḥ/\hskip-4pt/
        hiraṇyagarbha ṛṣiḥ/\hskip-4pt/
        nandi vāhanaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{prāṇaḥ}
          \rdg[wit={U2}]{\korr prāṇa°}} vāyuḥ/\hskip-4pt/
        jyotiḥ kalākāraṇaṃ dehe/\hskip-4pt/
        suṣuptir\skp{-}avasthā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{paśyantī}
          \rdg[wit={U2}]{\korr paśyaṃti}} vācā/\hskip-4pt/
        sāmavedaḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{gārhapatyo 'gniḥ}
          \rdg[wit={U2}]{\korr gārhasyatyo gniḥ}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{śivo}
          \rdg[wit={U2}]{\korr śiva°}} liṇgaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{prāptiḥ}
          \rdg[wit={}]{\korr prāpti°}} bhūmikā/\hskip-4pt/
        sarūpatā muktiḥ/\hskip-4pt/
        dvādaśādalāni/\hskip-4pt/
        dvādaśamātrā/\hskip-4pt/
        kaṃ khaṃ gaṃ ghaṃ ṇaṃ caṃ chaṃ jaṃ jhaṃ yaṃ taṃ thaṃ/\hskip-4pt/
        bahir\skp{-}mātrā/\hskip-4pt/
        rudrāṇī/\hskip-4pt/
        tejasā/\hskip-4pt/
        tāpinī/\hskip-4pt/
        sphakadā/\hskip-4pt/
        ...
        mātara/\hskip-4pt/
        jvālā/\hskip-4pt/
        prajvālinī/\hskip-4pt/}\note[type=philcomm, labelb=s11.z11, lem={anāhatacakraṃ}]{This additional passage is found in U2 only and concluded in the manuscript with ``|| ajapājapasahasra || 6000 gha. 96 pa. 40 ||''. \textit{Ajapājapa} is to be performed 6000 times for a duration of 96 \textit{ghaṭi}s and 40 \textit{pala}s, resulting in 2320 minutes or 38.67 hours. Again this would result in a frequence of breath of 2,586206897 in- and exhalations per minute.} 
    \end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{[The] Anāhatacakras place is within the heart\footnote{This seems to be redundant.}. The color is white. The quality is \textit{tamas}. The deity is Rudra. The power is Umā. The Ṛṣi is Hiraṇyagarbha. The mount is Nandi. The vitalwind is Prāṇa. In the body it is the light that causes parts (\textit{kalākaraṇa})\footnote{What is this?!}. The state is deep sleep. The speech is \textit{Paśyantī}\footnote{Add footnote of entry in \textit{Tāntrikābhidhānakośa}.}.The [Veda] is Sāmaveda. The fire is Gārhapatya\footnote{Add explanation.}. The Liṅgam is Śivaliṅga. The ability to attain is the earth. The liberation is the uniform liberation. [There are] twelve petals, [and] twelve measures: kaṃ khaṃ gaṃ ghaṃ ṇaṃ caṃ chaṃ jaṃ jhaṃ yaṃ taṃ [and] thaṃ. The external measure: Rudra's wife, light (\textit{tejasā?}), glow, \textit{sphakadā}?, consciousness (\textit{caitanyā}), bestower of grace, peace, Umā, Gaurī, Mātara, the flame [and] Prajvālinī.}
    \end{tlate}
  \end{translation}
 %%
 %%
...
%-----------------------
%In its middle exists a lotus facing downward having eight petals. %\extra{The mind resides in this \textit{cakra}. The mind is the deity. The power is Barhi\footnote{n. Streu. Opferstreu, gewöhnlich aus Kuśa-Gras bestehend, welche über den Opferplatz. insbes. die Vedi, gestreut wird, als eine reine Decke, auf welcher die Gnaden ausgebreitet werden, und welche den Göttern und Opfernden zum Sitz dient.}, [its] Ṛṣi is the self. In the middle of the navel [exists] a place, being a lotus, its tube measures ten \textit{aṅgula}s. The fluid (\textit{komala}) of the tube is pure facing upwards. In its middle is a place shining like a banana-flower. The mind isn't willing to rise up and is of changing nature.}%-----------------------
% While [the mind is situated] in the eastern petal [which is] white in color - Dharma, fame, knowledge etc. the clear intellect arises.
% While [the mind is situated] in south-east, [which is] reddish in color - sleep, laziness, illusion and a weak mind arises.
% While [the mind is situated] in the right south, [which is] black in color then anger is generated.
% While [the mind is situated] in the southwest, [which is] blue in color a mind that is selfish arises.
% While [the mind is situated] in the west, [which is] brown in color a mind of payfulness, laughing, and party-mood arises.
% While [the mind is situated] in the northwest, [which is] dark in color a mind of restless thought arises.
% While [the mind is situated] in the north, [which is] yellow in color a mind of great happiness, erotic and enjoyment arises.
% While [the mind is situated] in north-east [which is] whitish in color a mind endowed with unified knowledge arises.      
%-----------------------
...
Due to being made of [such an] intense light [the fourth lotus] is not in the range of sight. In its middle exists a lotus facing downward having eight petals.
  ...
  \begin{edition}
     \ekddiv{type=ed}
\begin{prose}
  \extra{manaś-cakre/\hskip-4pt/
    mano devatā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{barhiḥ śaktiḥ}
          \rdg[wit={U2}]{\korr bahiśaktiḥ}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{ātmā}
          \rdg[wit={}]{\korr ātma°}} ṛṣih/\hskip-4pt/
        ...
        mana unnaty-\app{\lem[type=emendation, resp=egoscr]{asaṃkalpam}
...
\end{prose}
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{The mind resides in this \textit{cakra}. The mind is the deity. The power is Barhi\footnote{n. Streu. Opferstreu, gewöhnlich aus Kuśa-Gras bestehend, welche über den Opferplatz. insbes. die Vedi, gestreut wird, als eine reine Decke, auf welcher die Gnaden ausgebreitet werden, und welche den Göttern und Opfernden zum Sitz dient.}, [its] Ṛṣi is the self. In the middle of the navel [exists] a place, being a lotus, its tube measures ten \textit{aṅgula}s. The fluid (\textit{komala}) of the tube is pure [and] facing upwards. In its middle is a place shining like a banana-flower. The mind isn't willing to rise up and is of changing nature.}
    \end{tlate}
  \end{translation}
%%%%
%%%%
%%%%
  \begin{edition}
    ...
    \begin{prose}
        \extra{
        pūrvadale svetavarṇe yadā viśrāmate manaḥ/\hskip-4pt/
        dharmakīrtividyādi sadbuddhir-bhavati/ %While [the mind is situated] in the eastern petal [which is] white in color - Dharma, fame, knowledge etc. the clear intellect arises.
        %%%%%
        agnikoṇe āraktavarṇe nidrā ālasyamāyāmandamatir-bhavati/  %While [the mind is situated] in south-east, [which is] reddish in color - sleep, laziness, illusion and a weak mind arises.
        %%%%
        dakṣiṇe kṛṣṇavarṇeti tadā krodhotpattir-bhavati/ %While [the mind is situated] in the right south, [which is] black in color then anger is generated.
        %%%
        naiṛtye nīlavarṇe mamatāmatir-bhavati/ %While [the mind is situated] in the southwest, [which is] blue in color a mind that is selfish arises.
        %%%
        paścime kapilavarṇe krīḍāhāsotsavotsāhamatir-bhavati/ %While [the mind is situated] in the west, [which is] brown in color a mind of payfulness, laughing, and party-mood arises.
        %%%
        vāyav ye śāmavarṇe cintodvegamatir-bhavati/ %While [the mind is situated] in the northwest, [which is] dark in color a mind of restless thought arises.
        %%%
        uttare pītavarṇe bhogaśṛṇgāramahodayamatir-bhavati/ %While [the mind is situated] in the north, [which is] yellow in color a mind of great happiness, erotic and enjoyment arises.
        īśāne gauravarṇe
        \app{\lem[type=emendation, resp=egoscr, alt={jñānasaṃdhāna°}]{jñānasaṃdhāna}
          \rdg[wit={U2}]{\korr jñānasaṃdhāne}}
        matir-bhavati/} %While [the mind is situated] in north-east [which is] whitish in color a mind endowed with unified knowledge arises.
\end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
      \extra{
 While [the mind is situated] in the eastern petal [which is] white in color - Dharma, fame, knowledge etc. the clear intellect arises. While [the mind is situated] in south-east, [which is] reddish in color - sleep, laziness, illusion and a weak mind arises. While [the mind is situated] in the right south, [which is] black in color then anger is generated. While [the mind is situated] in the southwest, [which is] blue in color a mind that is selfish arises. While [the mind is situated] in the west, [which is] brown in color a mind of payfulness, laughing, and party-mood arises. While [the mind is situated] in the northwest, [which is] dark in color a mind of restless thought arises. While [the mind is situated] in the north, [which is] yellow in color a mind of great happiness, erotic and enjoyment arises. While [the mind is situated] in north-east [which is] whitish in color a mind endowed with unified knowledge arises.}  
    \end{tlate}
  \end{translation}
    \begin{edition}
      \ekddiv{type=ed}
...
ityatra \app{\lem[wit={ceteri}]{kiṃ}
  \rdg[wit={E,P,L,U2}]{\om}}
\app{\lem[wit={ceteri}]{kathyate}
  \rdg[wit={U1}]{kathyate vā}}/\hskip-4pt/
  \end{prose}
\end{edition}
\begin{translation}
  \ekddiv{type=trans}
...
%-----------------------
%U2 continues: dhūmra?varṇe jīvodevatā// avidyāśaktiḥ// virāṭharṣiḥ// vāyurvāhanaṃ// udānavāyuḥ// jvālākalā jālaṃdharobaṃdhaḥ mahākāraṇadeha// tūryāvasthā// parāvācā// atharvaṇavedaḥ// jaṃgamaliṅgaṃ jīvaprāptābhūmikā// sāyujyatāmokṣaḥ// ṣoḍaśadalāni// ṣoḍaśamātrāḥ// atarmātrār-carāḥ// aṃ āṃ iṃ īṃ u ūṃ ṛṃ ṝṃ ḷṃ ḹṃ eṃ aiṃ oṃ auṃ aṃ aṃḥ// bahirmātrā vidyā// avidyā// ichā// śakti// jñānaśaktiḥ// śatalā// mahāvidyā// mahāmāyā// buddhiḥ// tamasī// maitrā?// kumārī// maitrāyaṇī// rudrā// puṣṭa// siṃhanī// ajapājapasahasra/ 1000 gha 02 pa 046 akṣara 40//
%-----------------------     
%[It is] smoke-colored, [its] deity is the embodied soul (\textit{jīva}), [it is associated with the] power of ignorance (\textit{avidyā}), [its] Ṛṣi is Virāṭha, [its] mount is the vitalwind (\textit{vāyu}), [its] vitalwind is \textit{udāna}, [it belongs to] Jvālākalā (?), [associated with it is] Jālandharabandha, [and the] supra-causal body (\textit{mahākāraṇadeha}), [its] state is the fourth state (\textit{tūrya}), [its] speech is Parā\footnote{Im Kaśm. Śiv. °das ewige Wort, in welchem potentiell alle Begriffe und Worte ruhen; vgl. das śabdabrahma des Vyākaraṇa. [B.]― Schmidt S. 246}, [it is associated with the] Atharvaveda, Jaṅgamaliṅga [and] Jīvaprāptābhūmikā?, [its] liberation is absorption into the divine essence (\textit{sāyujyatāmokṣaḥ}), [it has] sixteen petals [with] sixteen measures. [Its] internal measures are: aṃ āṃ iṃ īṃ u ūṃ ṛṃ ṝṃ ḷṃ ḹṃ eṃ aiṃ oṃ auṃ aṃ aṃḥ. [Its] external measures are: knowledge, ignorance, desire, power, the power of knowledge, \textit{śatalā}?, great knowledge, great illusion, intellect, dual darkness (\textit{tamasī}?), love, young girl?, Maitrāyaṇī?, Rudrā, abundance, lioness?.
%-----------------------  
  ...
  \begin{edition}
    ...
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{dhūmraṃ varṇaṃ}
          \rdg[wit={U2}]{\korr dhūmravarṇe}}/\hskip-4pt/
        jīvo devatā/\hskip-4pt/
        avidyā śaktiḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{virāṭho}
          \rdg[wit={U2}]{\korr virāṭha}} ṛṣiḥ/\hskip-4pt/
        vāyur\skp{-}vāhanaṃ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{udāno}
          \rdg[wit={U2}]{\korr udāna°}} vāyuḥ/\hskip-4pt/
        jvālā kalā/\hskip-4pt/
        jālaṃdharo bandhaḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{mahākāraṇaḥ dehaḥ}
          \rdg[wit={U2}]{\korr mahākāraṇadeha}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{tūrya āvasthā}
          \rdg[wit={U2}]{\korr tūryāvasthā}}/\hskip-4pt/
        parā vācā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{atharvaṇo}
          \rdg[wit={U2}]{\korr atharvaṇa}} vedaḥ/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{jaṅgamaṃ}
          \rdg[wit={U2}]{\korr jaṃgama°}} liṅgaṃ/\hskip-4pt/
        jīvaprāptā bhūmikā/\hskip-4pt/
        sāyujyatā mokṣaḥ/\hskip-4pt/
        ṣoḍaśadalāni/\hskip-4pt/
        ṣoḍaśamātrāḥ/\hskip-4pt/
        antarmātrār-carāḥ/\hskip-4pt/
        aṃ āṃ iṃ īṃ u ūṃ ṛṃ ṝṃ ḷṃ ḹṃ eṃ aiṃ oṃ auṃ aṃ aṃḥ/\hskip-4pt/
        bahir-mātrā/\hskip-4pt/
        vidyā/\hskip-4pt/
        avidyā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{icchā}
          \rdg[wit={U2}]{\korr ichā}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{śaktiḥ}
          \rdg[wit={U2}]{\korr śakti}}/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{jñānaḥ}
          \rdg[wit={U2}]{\korr jñāna°}} śaktiḥ/\hskip-4pt/
        śatalā/\hskip-4pt/
        mahāvidyā/\hskip-4pt/
        mahāmāyā/\hskip-4pt/
        buddhiḥ/\hskip-4pt/
        ...
        maitrā/\hskip-4pt/
        kumārī/\hskip-4pt/
        maitrāyaṇī/\hskip-4pt/
        rudrā/\hskip-4pt/
        \app{\lem[type=emendation, resp=egoscr]{puṣṭaḥ}
          \rdg[wit={U2}]{\korr puṣṭa°}}/\hskip-4pt/
        siṃhanī/\hskip-4pt/}\note[type=philcomm, labelb=s13.z13, lem={dhūmravarṇe}]{This additional passage is found in U2 only and is indicated in the manuscript with ``ajapājapasahasra | 1000 gha. 2 pa. 46 akṣara 40 ||''. What is akṣara?}%%%%%Kolloquium besprechen! 
    \end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{The colour is smoke-colour. The deity is the embodied soul (\textit{jīva}). The power is ignorance (\textit{avidyā}). The Ṛṣi is Virāṭha\footnote{Who is this?}. The mount is the vitalwind (\textit{vāyu}). The vitalwind is \textit{udāna}. Its Kalā is the flame. The \textit{bandha} is Jālandhara. The body supra-causal (\textit{mahākāraṇa}). The state is the fourth state (\textit{tūrya}). The speech is Parā\footnote{Im Kaśm. Śiv. °das ewige Wort, in welchem potentiell alle Begriffe und Worte ruhen; vgl. das śabdabrahma des Vyākaraṇa. [B.]― Schmidt S. 246}. The [Veda is] Atharvaṇa Veda. The \textit{liṅga} is the living. The earth/grade? is Jīvaprāptā\footnote{What is this?}. The liberation is absorption into the divine essence (\textit{sāyujyatā}). [There are] sixteen petals [and] sixteen measures. The internal measure: aṃ āṃ iṃ īṃ u ūṃ ṛṃ ṝṃ ḷṃ ḹṃ eṃ aiṃ oṃ auṃ aṃ aṃḥ. The external measure: knowledge, ignorance, desire, power, the power of knowledge, \textit{śatalā}?, great knowledge, great illusion, intellect, dual darkness (\textit{tamasī}?), love, young girl?, Maitrāyaṇī?, Rudrā, abundance, lioness?.}
    \end{tlate}
  \end{translation}
  %%%
  %%%
...
\begin{translation}
  \ekddiv{type=trans}
    \begin{tlate} In its  middle exists a single person which shines like a thousand moons. Because of the exercise of meditation on this person all diseases which are (otherwise) not possible to be controlled vanish. The person lives up to 1001 years.
    \end{tlate}
  \end{translation}
%\end{alignment}
%%%%
...
\end{prose}
  ...
  \begin{translation}
    ...
    \bigskip
    \begin{tlate}
Now it exists a sixth cakra named Ājñā.
    \end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}
     \extra{\app{\lem[type=emendation, resp=egoscr]{agnir}
         \rdg[wit={U2}]{\korr āgnir}} devatā/\hskip-4pt/
       suṣumṇā śaktiḥ/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{}
         \rdg[wit={}]{\korr }} 
       \app{\lem[type=emendation, resp=egoscr]{hiṃso}
         \rdg[wit={U2}]{\korr hiṃsa°}}ṛṣiḥ/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{caitanyaṃ}
         \rdg[wit={U2}]{\korr caitanya°}} vāhanaṃ/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{jñāno dehaḥ}
         \rdg[wit={U2}]{\korr jñānadehī}}/\hskip-4pt/
       vijñānāvasthā/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{anupamā}
         \rdg[wit={U2}]{\korr anupama°}} vācā/\hskip-4pt/
       sāmavedaḥ/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{pramādaḥ}
         \rdg[wit={U2}]{\korr pramāda°}} liṃgaṃ/\hskip-4pt/
       ardhamātrā/\hskip-4pt/
       ākāśā tatvaṃ/\hskip-4pt/
       jīvahiṃsa/\hskip-4pt/
       caitanyalīlāraṃbhaḥ/\hskip-4pt/
       dve mātrā/\hskip-4pt/
       haṃ kṣaṃ/\hskip-4pt/
       aṃtar-mātrā/\hskip-4pt/
       bahir-mātrā/\hskip-4pt/
       \app{\lem[type=emendation, resp=egoscr]{sthitiḥ}
         \rdg[wit={U2}]{\korr sthiti}}/\hskip-4pt/
       prabhā/\hskip-4pt/}\note[type=philcomm, labelb=s13.z17, lem={agnir devatā}]{This additional passage is found in U2 only and finished in the manuscript with ``ajapājapasahasra | 1000 gha 02 pa 046 akṣara 40 ||''.}
\end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{The deity is fire. The power is the godess of the centre (\textit{suṣumṇā}). The Ṛṣi is ``the violent'' (\textit{hiṃsa}). The mount is consciousness (\textit{caitanya}. The body is knowledge. The state is understanding. The speech is the ``incomparable'' (\textit{anupama}). The [Veda] is Sāmaveda.The \textit{liṅgaṃ} is intoxication (\textit{pramāda}). The half-measure: the reality of ether, ``the violence of living'' (\textit{jīvahiṃsa}) [and] the origin of the play of Conciousness. Two measures: haṃ kṣam. The inner measure is external measure: maintenance of life (\textit{sthiti}) [and] splendour (\textit{prabhā}).}
    \end{tlate}
  \end{translation}
  %%%
  %%%
...
%-----------------------
%N2: \extra{lalāṭamaṃḍalaṃ// caṃdrodevatā// amṛtāśaktiḥ// paramātmāṛṣiḥ// amṛtavāsinīkalāsaptadaśī amṛtakallolanadī// mahākāśa// aṃbikā// laṃbikā// ghaṃṭikā// tālikā// ajapāgāyatrīdehasvarūpaṃ// kākamukhī// naranetrāgośṛṃgālalāṭabrahmapaṭhāhayagrīvā// mayūramukhā// haṃsavadaṃgāni// ajapāgāyatrīsvarūpaṃ// 
%-----------------------
...
idānīṃ saptamaṃ
      ...
      vartate/ \extra{lalāṭamaṃḍalaṃ/\hskip-4pt/ caṃdrodevatā/\hskip-4pt/ amṛtāśaktiḥ/\hskip-4pt/ paramātmāṛṣiḥ/\hskip-4pt/ amṛtavāsinīkalāsaptadaśī/\hskip-4pt/ amṛtakallolanadī/\hskip-4pt/ mahākāśa/\hskip-4pt/ aṃbikā/\hskip-4pt/ laṃbikā/\hskip-4pt/ ghaṃṭikā/\hskip-4pt/ tālikā/\hskip-4pt/ ajapāgāyatrīdehasvarūpaṃ/\hskip-4pt/ kākamukhī/\hskip-4pt/ naranetrāgośṛṃgālalāṭabrahmapaṭhāhayagrīvā/\hskip-4pt/ mayūramukhā/\hskip-4pt/ haṃsavadaṃgāni/\hskip-4pt/ ajapāgāyatrīsvarūpaṃ/\hskip-4pt/ adhikataraprabhāmuktaṃ/\hskip-4pt/ atiśvetaṃ/\hskip-4pt/ tanmadhye raktavarṇaṃ ghaṭikāsaṃjñā/}
%-----------------------
...
%-----------------------      
      adhi\app{\lem[wit={ceteri}]{°kataraśobhayuktaṃ}
...
%-----------------------
       \app{\lem[wit={ceteri},alt={niraṃtaradhyānakaraṇād}]{niraṃtaradhyānakaraṇād\skm{a}}
         \rdg[wit={E,P}]{nirantaradhyānād}}\app{\lem[wit={ceteri}, alt={amṛtadhārā}]{\skp{-a}mṛtadhārā}
...
%-----------------------
%gurudevatā// caitanyaśaktiḥ// virāṭu?ṛṣiḥ// sarvotkṛṣṭasākṣiḥ// bhūtaturyātītacaitanyātmakaṃ// sarvavarṇāḥ// sarvamātrāḥ// sarvadalāni virāṭudeha sthitāvasthā prajñāvācā sohaṃ veda anupamasthānaṃ// ajapājapasahasra/ 1000 gha 02 pa 046 akṣara 40// sarvajapasaṃkhyā// 21600// ekaviṃśatisahasrāṇiṣaṭśatāni// tathaivaca niśāhevahate// prāṇaḥ yojānātisapaṃḍitaḥ// sakāreṇa bahiryātihakāreṇaviśotpunaḥ// haṃsaḥ sohaṃ// tato maṃtraṃ jīvojapati sarvadā//    
%-----------------------
...
%-----------------------
      ...
      vartate/ \extra{gurudevatā/\hskip-4pt/ caitanyaśaktiḥ/\hskip-4pt/ virāṭuṛṣiḥ/\hskip-4pt/ sarvotkṛṣṭasākṣiḥ/\hskip-4pt/ bhūtaturyātītacaitanyātmakaṃ/\hskip-4pt/ sarvavarṇāḥ/\hskip-4pt/ sarvamātrāḥ/\hskip-4pt/ sarvadalāni virāṭudehasthitāvasthā prajñāvācā sohaṃ veda anupamasthānaṃ/\hskip-4pt/ sarvajapasaṃkhyā/\hskip-4pt/ 21600/\hskip-4pt/ ekaviṃśatisahasrāṇiṣaṭśatāni/\hskip-4pt/ tathaiva ca niśāhevahate/\hskip-4pt/ prāṇaḥ yojānātisapaṃḍitaḥ/\hskip-4pt/ sakāreṇa bahir-yāti hakāreṇa viśotpunaḥ/\hskip-4pt/ haṃsaḥ sohaṃ/\hskip-4pt/ tato mantraṃ jīvo japati sarvadā/\hskip-4pt/}\note[type=philcomm, labelb=s17.z3, lem={gurudavetā...ajapājapasahasra}]{This additional passage is found in U2 only and is indicated or concluded in the manuscript with ``1000 gha 02 pa 046 akṣara 40''. Is this a quotation? Or is this a certain instruction for the mode or pace of recitation?}
...
%---------------------
        \app{\lem[alt={atiśayenāyur},wit={E,P}]{atiśayenāyu\skp{r-}}
          ...
          \rdg[wit={B,L}]{vardhayate}}/\hskip-4pt/        
    \end{prose}
\end{edition}
\begin{translation}
  \ekddiv{type=trans}
...
%---------------------
idānīṃ
\app{\lem[wit={ceteri}]{navamacakrasya}
...
tasya \app{\lem[wit={ceteri}, alt={mahāśūnya°}]{mahāśūnya}
  ...
  \rdg[wit={U2}]{\om}}\app{\lem[wit={ceteri}]{cakreti}
...
\app{\lem[wit={E,P,B},alt={tadupary}]{tadupary\skm{a-}}
  ...
  \rdg[wit={B,L,U2}]{\om}}
\app{\lem[wit={ceteri}]{kiṃ api nāsti}
  \rdg[wit={U2}]{\om}}/
%------------------------------
...
\end{translation}
 ...
 \begin{prose} 
   ...
   \app{\lem[type=emendation, resp=egoscr]{sakarā}
    \rdg[wit={U2}]{\korr sakaro}} bhavatī/\hskip-4pt/ prāṇī rūḍho bhavej-jīva ārohaty-avarohati bhavaguhāsthānaṃ pitavarṇaṃ/\hskip-4pt/ koṭisūryapratikāśaṃ tejaḥ sadoditaprabhā śīvo devatā/\hskip-4pt/ mūlamāyāśaktiḥ/\hskip-4pt/ hara ātmālayāvsthā dhvanisthirānādātmako khaṃḍadhvani/\hskip-4pt/ aghorāmudrā/\hskip-4pt/ mūlamāyā/\hskip-4pt/ prakṛtidehaḥ/\hskip-4pt/ vāṅmanogocaraḥ/\hskip-4pt/ niḥprapañcaḥ/\hskip-4pt/ niḥsaṃśayaḥ/\hskip-4pt/ nistaraṃ hanir-lopalakṣaṃ laya/\hskip-4pt/ dhyānasamādhi/\hskip-4pt/}
%---------------------
...
yaḥ
\app{\lem[wit={ceteri}]{kaścid-adṛṣṭaḥ}
...
\app{\lem[wit={N2}, alt={dṛḍhīkaraṇād}]{dṛḍhīkaraṇād\skm{-dṛ}}
  ...
  \rdg[wit={B}]{dṛḍhīkaraṇān}}\app{\lem[wit={ceteri}, alt={dṛṣṭiḥ}]{\skp{-dṛ}ṣṭiḥ}
...
\begin{edition}
  \ekddiv{type=ed}
   \centerline{\textrm{\small{[Description of \textit{caryāyoga}]}}}
      \bigskip
 \begin{prose}
%----------------------------
...
sa eva
\app{\lem[wit={ceteri}]{caryāyogaḥ}
  \rdg[wit={N1,N2,D1,U1}]{kriyāyogaḥ}}//
...
\begin{edition}
  \ekddiv{type=ed}
    \centerline{\textrm{\small{[Description of \textit{haṭhayoga}]}}}
      \bigskip
      \begin{prose}
%------------------------------
...
\app{\lem[wit={N2}]{jvaranaṃ na bhavati}
  ...
  \rdg[wit={ceteri}]{\om}}/
\app{\lem[wit={ceteri}, alt={āyur}]{āyu\skp{r-}}
  \rdg[wit={N2}]{āyu°}
  \rdg[wit={D1}]{\om}}
\app{\lem[wit={ceteri},alt={vṛddhir}]{\skm{r-}vṛddhi\skp{r-}}
  \rdg[wit={E,L,D1}]{\om}}
\app{\lem[wit={ceteri}]{bhavati}
  \rdg[wit={B}]{bhavatī}
...
vibhāsvaraṃ/}\\ 
\tl{
\app{\lem[wit={ceteri}]{avikalpatayā}
  \rdg[wit={U1,U2}]{āvikalpatayā}}
\app{\lem[wit={ceteri}]{yuktyā}
  \rdg[wit={L,B}]{yuktā}} 
jñānayogaṃ samācaret/\hskip-4pt/1\hskip-2pt/\hskip-4pt/}\\ 
\end{tlg}
%------------------------------
...
\begin{tlg}
  ...
  \tl{
    ...
    \app{\lem[wit={ceteri},alt={kṣitāv}]{kṣitāv\skm{-u}}
      ...
      \rdg[wit={E}]{\om}}/\hskip-4pt/3\hskip-2pt/\hskip-4pt/}\\ 
\end{tlg}
%------------------------------
...
\app{\lem[wit={E}]{śākhākuṇḍalapallavāḥ}
  ...
  \rdg[wit={P}]{\om}}/\hskip-4pt/4\hskip-2pt/\hskip-4pt/}\\ 
\end{tlg}
%------------------------------
...
\app{\lem[wit={ceteri}]{svabhāvataḥ}
  ...
  \rdg[wit={D1}]{bhāvataḥ}}/}\\
\tl{
  \app{\lem[wit={ceteri}]{tathāsau}
    \rdg[wit={B}]{yathāsau}
    \rdg[wit={P}]{tathāpasau}}
  \app{\lem[wit={ceteri}]{nirmalo}
    \rdg[wit={P}]{nirmalau}}
nityo nirvikāro niraṃjanaḥ/\hskip-4pt/5\hskip-2pt/\hskip-4pt/}\\ 
\end{tlg}
\end{edition}
\begin{translation}
  \ekddiv{type=trans}
...
\tl{
  \app{\lem[wit={E}]{paṃcatattvamanobuddhimāyāhaṃkāravikriyāḥ}
    \rdg[wit={P,U1}]{°buddhir}
    \rdg[wit={B,L}]{°kriyā°}
    \rdg[wit={N1,N2,D1,U2}]{°buddhir māyāhaṃkāravikriyā}}/\hskip-4pt/6\hskip-2pt/\hskip-4pt/}\\ 
\end{tlg}
\end{edition}
\begin{translation}
   \ekddiv{type=trans}
  ...
  \begin{tlg}
   ...
   \tl{
     \app{\lem[wit={ceteri}]{eka}
       ...
       \app{\lem[wit={ceteri}]{eva}
         \rdg[wit={U1}]{yeva}}
       na cānyo sti yo jānāti sa tatvavit\hskip-4pt/7\hskip-2pt/\hskip-4pt/}\\
   \end{tlg}
   \end{edition}
\begin{translation}
  \ekddiv{type=trans}
...
%------------------------------
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}Transmigration is the appearance of the plant world, mountains, trees, earth etc. Transmigration is the appearance of living beings beginning with birds, horses, elephants and humans.\end{tlate}
  \end{translation}
%------------------------------
...
\app{\lem[wit={ceteri},alt={ity°}]{it\skp{y-u}}
  \rdg[wit={L,B}]{ty°}
  \rdg[wit={N2}]{śaty°}
}\skm{y-u}cyate/
    \end{prose}
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}And then whoever is one who is a [sense] object of sight is said to be visible. He who is not seen by sight is said to be invisible.\end{tlate}
  \end{translation}
%------------------------------
...
%------------------------------
%So ist die philosophische Lehre die Spaltung des im Geburtenkreislauf befindlichen eigenen Selbst mittels der Einheit zu entfernen. Nur das ist Jñānayogaḥ.
%------------------------------
%In this way the philosophical teaching is to remove the split of one's own self, which is subjected to transmigration by means of identity. Only that is Jñānayogaḥ.
%------------------------------
   \begin{edition}
     \ekddiv{type=ed}
     \begin{prose}
...
\app{\lem[wit={ceteri}]{jñānayogaḥ}
  \rdg[wit={U2}]{jñānayoga}}/ 
   ...
   \begin{translation}
     \ekddiv{type=trans}
     \begin{tlate}In this way the philosophical teaching is to remove the split of one's own self, which is subjected to transmigration by means of identity. Only that is Jñānayoga.\end{tlate}
   \end{translation}
%------------------------------
...
\app{\lem[wit={P,U2}]{svabhāvabhedaḥ}
  ...
  \rdg[wit={N2}]{°bheda}
  \rdg[wit={U1}]{°bhedāḥ}}
kathyate/\note[type=philcomm, labelb=s46.z7, lem={bhedaṃ}]{Let us see what happens next.}
    \end{prose}
  \end{edition}
    \begin{translation}
    \ekddiv{type=trans}
...
%------------------------------
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}\noindent Just as the seed of the banyan tree ripens into the shape of the banyan tree, and by its own inherent nature attains such a tenfold division. [Namely]:\end{tlate}
  \end{translation}
 %------------------------------ %%%%STEMMA POINT!!!!
...
%------------------------------
    ...
    \begin{translation}
      \ekddiv{type=trans}
      \begin{tlate}\noindent "Root, shoot, bark, branch, twig, bud, the unfolding flower, flower, fruit and nectar." The division reaches [those] ten parts.\end{tlate}
    \end{translation}
%------------------------------
...
ātmā iti niścayo bhavati/
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}Because of the power of Jñānayoga, there arises the certainty that "The Self is verily one."
\end{tlate}
  \end{translation}
\end{alignment}
\clearpage
%------------------------------
%yathaikaiva   pṛthvī  kvacit komalarūpā                           kvacit parimalarūparahitā                          kvacit suvarṇarūpā   kvacid raupyarūpā   kvacid ratnamayī   kvacicca śvetā kvacidratnamayī kvacicca śvetā kvacidraktā   kvacitpītā    \E %%%p.28 
%yathā ekaika  pṛthvī  kvacit komalarūpā                                                                                                                                                  \P   
%yathā ekaika  pṛthvī  kvacit komalarūpā// kvacit mano hararūpā//  kvacit parimalarūpayuktā// kvacit parimalarohitā// kvacit suvarṇarūpa                       kvacid ratnamaī//  kvacitśverūpā// kvacitkṛṣṇā//                 kvacidraktā/  kvacitpītā//  \B
%yathā ekaika  pṛthvī  kvacit komalarūpā   kvacit mano hararūpāḥ// kvacit parimalarūpayuktā// kvacit parimalarahitā// kvacit suvarṇarūpā                       kvacid ratnamaī//  kvacitśvetarūpā kvacitkṛṣṇā//                 kvacidraktā// kvacitpītā//  \L
%yathā ekaiva  pṛthivī kvacit komalarūpa/  kvacit mano harā/       kvacit parimalarūpāyuktā// kvacit parimalarahitā/  kvacit suvarṇarūpā/  kvacit rūpyarūpā/   kvacid ratnamayī/  kvacitśveta/    kvacitkṛṣṇa??/                kvacidrakta/  kvacitpītā/   \N1
%yathā ekaiva  pṛthivī kvacit komalarūpa   kvacit mano harā//      kvacit parimalarūpāyuktā/  kvacit parimalarohitā   kvacit suvarṇarūpa// kvacit rūpyarūpa//  kvacid ratnamayī// kvacitśvetā//   kvacitkṛ....[S8., Z.7]        kvacidrakta   kvacitpītā//  \D1
%yathā ekaṃ ca pṛthivī kvacit komalarūpa   kvacit mano ha?rā       kvacit parimalarūpāyuktaḥ/ kvacit parimalarohitā   kvacit suvarṇarūpā   kvacit rūpyarūpa    kvacid ratnamayī   kvacitśveta     kvacitkṛ....[S6. verso]       kvacidrakta   kvacitpītā    \N2
%yathā ekai ca pṛthivī kvacit                                                                                         khavarṇakupā         kvacit rūpyarūpā    kvacid ratnamayī   kvacitśveta     kvacitkṛṣṇā                   kvacidrakta   kvacitpītā    \U1
%yathā ekaika  pṛthvī  kvacit komalarūpā// kvacit mano hararūpa//  kvacit parimalarūpāyuktā/  kvacit parimalarohitā// kvacit suvarṇarūpā// kvacit rajatarūpā// kvacid ratnamayī// kvacitśvetā//   kvacitkṛṣṇā//                 kvacidraktā// kvacitpītā//  \U2
%------------------------------
%Wie ein bestimmter Erdboden (\textit{ekaika}) nur aufgrund seiner inhärenten Natur manchmal weich erscheint, manchmal schön erscheint, manchmal mit Wohlgeruch versehen ist, manchmal rötlich ist, manchmal golden erscheint, manchmal silbern erscheint, manchmal aus Edelstein gemacht ist, manchmal weiß erscheint, manchmal schwarz, manchmal kupfern, manchmal gelb, 
%------------------------------
%kvacitkarburā   kvacin nānāvidharūpā        kvacidviṣarūpā    kvacidamṛtarūpamayī svabhāvata eva bhavati//  \E  %%%p.28
%                                                              kvacidamṛtamayī     svabhāvata eva bhavati    \P  %%%rest is \om
%kvacitkarburā// kvacin nānāvidhaphalarūpā   kvacit viṣarūpā// kvacidamṛtamaī/     svabhāvata eva bhavataḥ// \B
%kvacitkarburā// kvacin nānāvidhāphalarūpā   kvacit viṣarūpā// kvacid amṛtamaī//   svabhāvata eva bhavataḥ// \L
%kvacitkarburā,  kvacin nānāvidhaphalarūpā/  kvacidpuṣparūpā,  kvacidamṛtamayī     svabhāvata eva bhavati/   \N1
%kvacitkarburā   kvacin nānāvidhaphalarūpā// kvacidpuṣparūpā// kvacidamṛtamayī/    svabhāvata eva bhavati//  \D1
%kvacitkarburā   kvacin nānāvidhaphalarūpā                     kvacidamṛtamayī/    svabhāvata eva bhavati//  \N2
...
%------------------------------
%machmal gesprenkelt, machmal wie verschiedenartige Frucht erscheint, manchmal wie Blumen erscheint, machmal wie der Nektar der Unsterblichkeit erscheint, 
%------------------------------
...
%tathātmā//    manuṣyapakṣi// hariṇahastīvidyādharagandharvakinnaramahāpaṃḍitamahāmūrvarogī arogīkrodhīśāṃtarūpasvabhāvād eva bhavati/ \D1
%tathātmā//    manuṣyapakṣihariṇahastividyādharagandharvakinnaramahāpaṇḍitamahāmūrkharogīarogīkrodhīśāṃtarūpasvabhāvād eva bhavati/ \N2
...
%------------------------------
%Auf diese Weise erscheint [auch] das Selbst aufgrund seiner inhärenten Natur als Mensch, Vogel, Gazelle, Elefant, als Vidyādhara, Gandharva, Zentaur, als großer Gelehrter oder großer Dummkopf, als Kranker oder Gesunder, als Zorniger oder Friedlicher. 
%------------------------------
...
%
%------------------------------
%parameśvaro'khaṇḍaparipūrṇaḥ/  \E
%parameśvaro khaṃdaparipūrṇaś ca    \P
%parameśvaro khaṃdaparipūrṇaś ca// \B
%parameśvaro khaṃdaparipūrṇaś ca//  \L
%parameśvaro 'ṣaṃḍaparipūrṇaś ca//  \N1
%parameśvaro ṣaṃda?paripūrṇaś ca//  \D1 %%%S.9 verso
%parameśvaro yarāṇdaparipūrṇaś ca//  \N2
