  ...
  \begin{ekdosis}
    ...
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{dhūmraṃ varṇaṃ}
        ...
        ṣoḍaśadalāni\dd{}
        ṣoḍaśamātrāḥ\dd{}
        antarmātrār-carāḥ\dd{}  %%%what does carā here mean? 
...
\begin{ekdosis}
 ...
 \begin{prose}
%----------------------- 
%īdānīṃ ṣaṣṭhaṃ bhrūmadhye ājñā cakraṃ                vartate//   \E
%īdānīṃ ṣaṣṭhaṃ bhrūmadhye ājñā cakraṃ                vartate//   \P
%īdānīṃ ṣaṣṭhaḥ bhrūmadhye ājñā cakraṃ                vartate//   \L
%idānīṃ ṣaṣṭhacakraṃ       ajñā nāmakaṃ               varttate // \N1
%idānīṃ ṣaṣṭhacakraṃ       ajñā nāmaka                varttate    \N2
%idānīṃ ṣaṣṭhacakraṃ       ajñā nāmakaṃ               varttate // \D1
%idānīṃ ṣaṣṭhacakraṃ       ājñā nāmakaṃ               vartate     \U1
%idānīṃ ṣaṣṭa   bhrūmadhye ājñā cakraṃ raktavarṇaṃ //             \U2
%-----------------------
  ...
  \begin{ekdosis}
    ...
    \begin{prose}
     \extra{\app{\lem[type=emendation, resp=egoscr, alt={agnir}]{agni\skp{r-de}}
         \rdg[wit={U2}]{\korr āgnir}} \skm{r-de}vatā\dd{}
       suṣumṇā śaktiḥ\dd{}
    ...
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{gurur}
        ...
        sohaṃ veda anupamasthānaṃ\dd{}
         \app{\lem[type=emendation, resp=egoscr]{ajapājapaḥ sahasraḥ}
          \rdg[wit={U2}]{\korr ajapājapasahasra}}\dd{} 1000 gha. 2 pa. 46 akṣara 40\dd{}
        ...
        sakāreṇa bahir-yāti hakāreṇa viśotpunaḥ\dd{} %%%what is viśotpunaḥ 
        haṃsaḥ sohaṃ\dd{}
        tato mantraṃ jīvo japati sarvadā\dd{}}\end{prose}\end{ekdosis}
  %%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%
...
%%%%%%%%%%%%
 ...
 \begin{prose} 
  ...
  %   \rdg[wit={U2}]{\korr sakaro}}
   ...
   niḥprapañcaḥ\dd{}
   niḥsaṃśayaḥ\dd{}
   \app{\lem[type=emendation, resp=egoscr, alt={nistaraṃga°}]{nistarāṃga}
     \rdg[wit={U2}]{\korr nistaraṃga}}nirlepalakṣaṃ \app{\lem[type=emendation, resp=egoscr]{layaṃ}
     \rdg[wit={U2}]{\korr laya}}\dd{}
   \app{\lem[type=emendation, resp=egoscr]{dhyānaṃ samādhiḥ}
...
%------------------------------
% of the one fruit Blütenkranz/Girlande die Verliebte (biene) führt ein unmittelbar über dem Kreis des Blütenstempels der wie eine Brust ist ein.
%Die Verliebte (Biene) platziert sich auf dem Blütenkranz über dem Kreisförmigen Blütenstempel der wie ein Brust ist. %%em. zu tuṇḍa???   
%------------------------------
ekasya
\app{\lem[wit={ceteri}]{phalasya}
...
%------------------------------
%Die eine Frucht schleudert den Nektar über die Blüte. Dies ist die inhärente Natur der Sache. So genießt auch das eine Selbst genießt aufgrund des eigenen Seins alle möglichen die acht Genüsse. 
%------------------------------
...
%--------------------------------------------
%,houses endowned with five or seven rooms in which there is wealth. A huge, very soft and lovely bed.  
%-------------------------------------------
\begin{ekdosis}
  \ekddiv{type=ed}
  \begin{prose}
...
\app{\lem[type=emendation, resp=egoscr]{śālikā}
  ...
  \rdg[wit={U2}]{saudhāni}}
harmyāṇi
\app{\lem[type=emendation, resp=egoscr]{teṣu vastu}
  \rdg[wit={L,B}]{\korr teṣu vāstu}
...
%------------------------------
%die acht genüsse wurden erzählt. Sie bringen Leid und sie flehen um Almosen? [em. zu yācayate?] sie veranlassen einen für sich selbst du bettlen.?
%------------------------------
\begin{ekdosis}
  \ekddiv{type=ed}
  \begin{prose}
...
%gurudrak pāt patrāṇāṃ             satyavādinām// kathanād viṣapānādvā   sānnitdhyavalokanāt//1//  \L
...
%%%%%%%%%%%%%%%%%%%%
 \ekddiv{type=trans}
          \begin{tlate}
            \extra{The forehead is a circle. The moon is the deity. The power is the nectar of immortality. The Rṣi is the supreme self. [It has] seventeen digits belonging to baleria plant of the nectar of immortality. [There is] the river of the wave of immortality, the great space, the mother, the uvula [and] a small bell.  The unspeakable Gayatrī [having] has a bodily nature [which is as follows]: the face of a crow, the eye of a human, the horn of a cow, a forehead that is like Brahmapaṭhā?, a neck like a horse, the face of a peacock [and] limbs like a goose. [This is?] the form of the unspeakable Gayatrī.}    
            \end{tlate}
%%%%%%%%%%%%%%%%%%%
\ekddiv{type=trans}
\begin{tlate}
...
\begin{tlate}
  ...
  2. Houses endowed with five or seven rooms in which there is wealth; \hfill \break
