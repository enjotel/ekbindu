...
\SetHooks{
  ...
  %appheight=0.65\textheight,
  fitalgorithm=hybrid, %fontsize|hybrid|areasize|squeeze
}
...
%  -----------------------        
        \tl{yasyai tāni \app{\lem[wit={ceteri}]{na}\rdg[wit={E}]{ca}} vidyante kriyāyogī sa ucyate\dd{}4\hskip-2pt\dd{}}\\
\bigskip
\end{tlg}
    \end{edition}
    \begin{translation}
...
%-----------------------      
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
      \extra{The gender is the location. The color is yellow. The shine is yellow. \textit{Rajas} is the quality. The deity is Brahmā. The speech is \textit{vaikharī}\footnote{vaikharī f. in Kaśm. Śiv. °the 4. form of appearacne of \textit{parā}, the empirical speech sound, Utpala's Ṭīkā to Śivadṛṣṭi 2, 7. [B.]― Schmidt p. 337. Welches Buch???} (\textit{vaikharīvāca}). The power is Sāvitrī. The mount is the goose. The \textit{Rṣi} is Vahaṇa. The appearance (\textit{prabhā} is the fire of love (\textit{kāmāgni}). The body is gross, The state is that of being awake. [The Veda associated with it is] the Ṛgveda. The spiritual guide is the \textit{liṅga}. The liberation is residing in the world of Brahma. The Tattva is the pure earth (\textit{śuddhabhumikā}). The sphere is smell. The vitalwind is \textit{apāna}. The internal alphabet [is]: vaṃ bhaṃ maṃ yaṃ raṃ laṃ. The external alphabet: desire, the Tīrtha of \textit{Kāmākhyā}\footnote{The Kāmākhyā is situated in Kāmarūpa on the Nīlakūṭa mountain in present day Assam. It's strange that it appears here, since Kāmarūpa appears already as the \textit{tīrtha} associated with the first \textit{cakra}.}, beauty of both\footnote{Why dual here?}, \textit{ceṣṭṛikā} (what is that?), lazy [and] copulation.} \end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}      
    ...
    \begin{prose}    
      \extra{
        ...
        \app{\lem[type=emendation, resp=egoscr, alt={vāyur}]{vāyu\skp{r-}}
          \rdg[wit={U2}]{\korr vayu°}}\skm{-r}ṛṣiḥ\dd{}
    ...
    \begin{prose}
      \extra{anāhatacakraṃ hṛdayasthānaṃ\dd{}
        ...
        \app{\lem[type=emendation, resp=egoscr]{śivo}
          \rdg[wit={U2}]{\korr śiva°}} liṇgaṃ\dd{}
        \app{\lem[type=emendation, resp=egoscr]{prāptiḥ}
          \rdg[wit={}]{\korr prāpti°}} bhūmikā\dd{}
        sarūpatā muktiḥ\dd{}
        dvādaśādalāni\dd{}
        dvādaśamātrā\dd{}
  ...
  \extra{manaś-cakre\dd{}
    mano devatā\dd{}
        \app{\lem[type=emendation, resp=egoscr]{barhiḥ śaktiḥ}
          \rdg[wit={U2}]{\korr bahiśaktiḥ}}\dd{}
        \app{\lem[type=emendation, resp=egoscr]{ātmā}
          \rdg[wit={}]{\korr ātma°}} ṛṣih\dd{}
...
%%%%
  \begin{edition}
    ...
    \begin{prose}
        \extra{
        pūrvadale svetavarṇe yadā viśrāmate manaḥ\dd{}
    ...
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{dhūmraṃ varṇaṃ}
        ...
        \app{\lem[type=emendation, resp=egoscr]{jñānaḥ}
          \rdg[wit={U2}]{\korr jñāna°}} śaktiḥ\dd{}
        śatalā\dd{}
        mahāvidyā\dd{}
        mahāmāyā\dd{}
        buddhiḥ\dd{}
  ...
  \begin{edition}
    ...
    \begin{prose}
     \extra{\app{\lem[type=emendation, resp=egoscr]{agnir}
         \rdg[wit={U2}]{\korr āgnir}} devatā\dd{}
       suṣumṇā śaktiḥ\dd{}
  ...
  \begin{edition}
    ...
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{lalāṭaṃ}
          \rdg[wit={U2}]{\korr lalāṭa°}} maṃḍalaṃ\dd{}
        caṃdro devatā\dd{}
        amṛtā śaktiḥ\dd{}
        paramātmā ṛṣiḥ\dd{}
        amṛtavāsinī kalā saptadaśī\dd{}
        amṛtakallolanadī\dd{}
        mahākāśa\dd{}
        aṃbikā\dd{}
        laṃbikā\dd{}
        ...
        \begin{translation}
          \ekddiv{type=trans}
          \begin{tlate}
            \extra{The forehead is a circle. The moon is the deity. The power is the nectar of immortality. The Rṣi is the supreme self. [It has] seventeen digits belonging to baleria plant of the nectar of immortality. [There is] the river of the wave of immortality, the great space, the mother, the uvula [and] a small bell. The bodily form of the unspeakable Gayatrī, [having] the face of a crow, the eye of a human, the horn of a cow, a forehead that is like Brahmapaṭhā?, a neck like a horse, the face of a peacock [and] limbs like a goose. [This is?] the form of the unspeakable Gayatrī.}    
            \end{tlate}
          \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
...
%-----------------------      
      adhi\app{\lem[wit={ceteri},alt={°kataraśobhayuktaṃ}]{kataraśobhayuktaṃ}
        ...
        atiśvetaṃ\dd{}\note[type=philcomm, labelb=s17.z4, lem={adhikataraśobhayuktaṃ}]{It seems that the passage \textit{``adhikataraśobhayuktaṃ || atiśvetaṃ ||''}, which is found in all witnesses is a remainder of those lists that might have only survived in U2.} %%%%%%%%%%%%%%%DISCUSS IN KOLLOQUIUM!!! 
        tanmadhye
...
\end{prose}
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}It is endowed with superabundant beauty. [It is] very bright. In its middle, red in color [is that which is] known as "uvula" (\textit{ghāṃṭikā}). [It] exists as a single pericarp. In its middle is a [certain] site. In the middle of it exists a flow of nectar like a river (\textit{amṛtādhārāsravantī}), appearing from the digits of the moons disc.
    \end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
...
Now exists the eigth \textit{cakra} having one hundred petals located at the aperture of Brahman.
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \begin{prose}
      \extra{\app{\lem[type=emendation, resp=egoscr]{gurur}
          \rdg[wit={U2}]{\korr guru°}}-devatā\dd{}
        \app{\lem[type=emendation, resp=egoscr]{caitanyaḥ}
          \rdg[wit={U2}]{\korr caitanya°}} śaktiḥ\dd{}
        \app{\lem[type=emendation, resp=egoscr]{virāṭur}
          \rdg[wit={U2}]{\korr virāṭu}}-ṛṣiḥ\dd{}
        sarvotkṛṣṭasākṣiḥ\dd{}
        bhūtaturyātītacaitanyātmakaṃ\dd{}
        sarvavarṇāḥ\dd{}
        sarvamātrāḥ\dd{}
        sarvadalāni\dd{}
        virāṭudehasthitāvasthā\dd{} %doppelter Sandhi? 
        prajñā vācā\dd{}
        sohaṃ veda anupamasthānaṃ\dd{}
        \app{\lem[type=emendation, resp=egoscr]{sarvajapaḥ}
          \rdg[wit={U2}]{\korr sarvajapa°}} saṃkhyā\dd{}
        21600\dd{}
        ekaviṃśatisahasrāṇiṣaṭśatāni\dd{}
        tathaiva ca niśā he vahate\dd{} %%%Völlig unklar! 
        prāṇaḥ yo jānāti sa paṃḍitaḥ\dd{} %%prāṇaḥ = m nom pl
        sakāreṇa bahir-yāti hakāreṇa viśotpunaḥ\dd{}
        haṃsaḥ sohaṃ\dd{}
        tato mantraṃ jīvo japati sarvadā\dd{}}\note[type=philcomm, labelb=s17.z3, lem={gurudavetā...ajapājapasahasra}]{This additional passage is found in U2 only. Instead of the concluding the additions, here we have it inserted between the additions: ``ajapājapasahasra | 1000 gha. 2 pa. 46 akṣara 40 || sarvajapasaṃkhyā || 21600 || ekaviṃśatisahasrāṇiṣaṭśatāni ||''.}
  \end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\extra{The deity is the Guru. The power is consciousness (\textit{caitanya}). The Ṛṣi is Virāṭu. [Attributed to it, is] the high positioned witness in everything. [It has] the nature of consciousness that is beyond the fourth state of beings. [It has] all colours. [It has] all measures. [It has] all petals. The state is like dwelling in the body of Virāṭu. The speech is wisdom. The "I am that"-[expression] (\textit{soham}) is the sacred knowledge \textit{veda} [which is] the matchless place (\textit{anupamasthāna}). The count is all silent mutterings, [being] 21600. And in this way Niśāhevahate?. He who knows the breath, he is a learned. With the sound of "sa" he exhales, with the sound of "ha" inhales?: "I'm he, he's I". Because of that the embodied soul constantly utters the Mantra.}
    \end{tlate}
  \end{translation}
  \begin{edition}
    \ekddiv{type=ed}
...
\end{translation}
 ...
 \begin{prose} 
  ...
  \app{\lem[type=emendation, resp=egoscr]{mokṣo}
   ...
   agnicakre sakaro
   %\app{\lem[type=emendation, resp=egoscr]{sakarā}  %%%maybe also "sakāro bhavati"? -> In the circle of fire the letter sa arises?; or "sakāra bhavati" =  In the circle of fire is a being (\textit{bhavatī}) full of rays. 
  %   \rdg[wit={U2}]{\korr sakaro}}
   \app{\lem[type=emendation, resp=egoscr]{bhavati}
     \rdg[wit={U2}]{\korr bhavatī}}\dd{}
   prāṇī rūḍho bhavej-jīva ārohaty-avarohati bhavaguhāsthānaṃ pitavarṇaṃ\dd{}
   koṭisūryapratikāśaṃ tejaḥ\dd{}
   sadoditaprabhā śīvo devatā\dd{} %%%split and emend to sadoditā prabhā? and then || śivo devatā ||??
   mūlamāyā śaktiḥ\dd{}
   hara ātmālayāvasthā dhvanisthirānādātmako \app{\lem[type=emendation, resp=egoscr]{'khaṇḍadvaniḥ}
     \rdg[wit={U2}]{\korr khaṃḍadhvani}}\dd{} %%Übersetzung unzufrieden 
   aghorā mudrā\dd{}
   \app{\lem[type=emendation, resp=egoscr]{mulo} %macht diese emdendation wirklich Sinn? 
   ...
   niḥprapañcaḥ\dd{}
   niḥsaṃśayaḥ\dd{}
   nistaraṃ hanir-lopalakṣaṃ \app{\lem[type=emendation, resp=egoscr]{layam}
     \rdg[wit={U2}]{\korr laya}}\dd{}
   dhyānasamādhi\dd{}}
\end{prose}
   \end{edition}
   \begin{translation}
...
\begin{tlg}
  ...
  \tl{
    ...
    \app{\lem[wit={ceteri}]{jñānādhikāravān}
      \rdg[wit={E}]{jñānādhikāraṇāt}}\dd{}3\hskip-2pt\dd{}}\\
\end{tlg}
%------------------------------
%
%\om!!!!!                                                                                                        \E
  ...
  \begin{tlg}
   ...
   \tl{
     \app{\lem[wit={ceteri}]{eka}
       ...
       \app{\lem[wit={ceteri}]{eva}
         \rdg[wit={U1}]{yeva}}
       na cānyo sti yo jānāti sa tatvavit/dd{}7\hskip-2pt\dd{}\\
   \end{tlg}
   \end{edition}
\begin{translation}
  \ekddiv{type=trans}
